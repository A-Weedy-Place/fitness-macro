...
export function DayTimeline({ entries, foods, onAddAt, onDelete, onOpenFood }: { entries: FoodEntry[]; foods: FoodItem[]; onAddAt: (time: string) => void; onDelete: (id: string) => void; onOpenFood?: (food: FoodItem) => void }) {
