...
- UI direction is quiet and practical, not an “AI dashboard”: neutral cards, one restrained accent colour per theme, no coloured atmosphere blobs, no special oversized AI tab, and equal bottom-tab icon dimensions. Themes automatically reload the app rather than asking the owner to restart it manually.
